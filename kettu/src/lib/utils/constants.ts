...
export const CODEBERG = "https://codeberg.org/cocobo1/Kettu"; // URL unchanged, repo still named Kettu
export const GITHUB = "https://github.com/C0C0B01/Kettu"; // URL unchanged, repo still named Kettu
...
export const V1VEU_DISCORD_SERVER_ID = "1368145952266911755";
export const V1VEU_PLUGINS_CHANNEL_ID = "1432796541210333284";
export const V1VEU_THEMES_CHANNEL_ID = "1408405946434195540";